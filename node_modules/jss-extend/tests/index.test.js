...
describe('jss-extend', function () {
  ...
  beforeEach(function () {
    ...
    jss = _get__('createFeuilleVisiteApresFauxBourdons.html')(_get__('settings')).use(_get__('extend')(), _get__('nested')(), _get__('expand')());
  });
...
function _get_original__(variableName) {
  switch (variableName) {
    ...
    case 'createFeuilleVisiteApresFauxBourdons.html':
      return _jss.create;
